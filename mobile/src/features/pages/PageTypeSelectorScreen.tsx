...
const PAGE_TYPES = [
  { type: 'personal' as const, label: 'Personal', blurb: 'Showcase your work or hobby — profession, portfolio.', icon: User, color: '#2196D6' },
...
export default function PageTypeSelectorScreen({ navigation }: Props) {
  return (
    <View className="flex-1 bg-white px-5 pt-4">
      <Text className="text-[18px] font-bold text-[#1F1B17]">What kind of page?</Text>
      <Text className="text-[13px] text-gray-500 mt-1">You can create more than one.</Text>
          ...
          return (
            ...
            >
              ...
              <View className="flex-1">
                <Text className="text-[15px] font-semibold text-[#1F1B17]">{pt.label}</Text>
                <Text className="text-[12px] text-gray-500 mt-0.5">{pt.blurb}</Text>
              </View>
